        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0">
              ...
              <center><h3>Technician Masterfile</h3></center>
            </div>
  ...
  <div class="modal-dialog modal-xl modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Technician Masterfile</h5>
      ...
      <div class="modal-body">
        ...
        <div class="col-6 col-sm-6">
          ...
          <div class="col-6 col-sm-6">
            <label for="recipient-name" class="col-form-label">Commuter Training</label>
            <input type="text" class="form-control" id="recipient-name" placeholder="Enter Model Code Here">
          </div>
          <div class="col-6 col-sm-6">
            <label for="recipient-name" class="col-form-label">Sportsmachine</label>
            <input type="text" class="form-control" id="recipient-name" placeholder="Enter Model Code Here">
          </div>
      ...
      label.textContent = 'Not Confidential';
        ...
        <thead style="background-color: #088395">
            <tr>
                ...
                <th  class="text-center text-uppercase text-white text-xs font-weight-bolder opacity-7">commuter training</th>
                <th  class="text-center text-uppercase text-white text-xs font-weight-bolder opacity-7">sportsmachine</th>
        ...
        <tbody>
            <tr>
                ...
                <td class="align-middle text-center text-sm" style='color: blue'>
                    <i class="fa fa-trophy"></i> <i class="fa fa-trophy"></i> <i class="fa fa-trophy"></i><i class="fa fa-trophy"></i> <i class="fa fa-trophy"></i><br>
                    <b style='color: black'>5 Trainings Completed</b>
                </td>
                <td class="align-middle text-center text-sm" style='color: blue'>
                    <i class="fa fa-trophy"></i> <i class="fa fa-trophy"></i> <br>
                    <b style='color: black'>2 Trainings Completed</b>
                </td>
        ...
        <td class="align-middle text-center text-sm" style='color: blue'>
            <i class="fa fa-trophy"></i></i> <i class="fa fa-trophy"></i><br>
            <b style='color: black'>2 Trainings Completed</b>
        </td>
        <td class="align-middle text-center text-sm">
           
            <b style='color: black'>0 Training Completed</b>
        </td>
        <td class="align-middle text-center">
        <a class="btn btn-link text-dark px-3 mb-0" href="javascript:;"><i class="fas fa-pencil-alt text-dark me-2" aria-hidden="true"></i>Edit</a>
        <a class="btn btn-link text-danger text-gradient px-3 mb-0" href="javascript:;"><i class="far fa-trash-alt me-2"></i>Delete</a>
